...
!!! note "Max confidence level"
    ...
    When creating knowledge in the platform, the maximum confidence level of the users is used. Please navigate to this [page](reliability-confidence.md#confidence-level-section) to understand this concept and the impact it can have on the knowledge creation.
